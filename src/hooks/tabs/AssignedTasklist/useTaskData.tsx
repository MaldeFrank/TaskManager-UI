...
import { useGetAssignedTasksByTasklistMonthly, useGetAssignedTasksByTasklistWeekly } from '../../../services/queries';
import { useAppDispatch } from '../../app/storeHook';
import { setTasklist } from '../../../redux/slicers/tasklistSlicer';
import { getAssignedTaskMonthly, getAssignedTasks, getAssignedTaskWeekly } from '../../../services/apiTasklist';

export const useTaskData = (tasklistId: number, taskFilter: string) => {
    const { data: weeklyTasks } = useGetAssignedTasksByTasklistWeekly(tasklistId);
    const { data: monthlyTasks } = useGetAssignedTasksByTasklistMonthly(tasklistId);
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [tasklistId, taskFilter, weeklyTasks, monthlyTasks, dispatch]);
};